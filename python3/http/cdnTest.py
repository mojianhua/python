...
class pushAliCdn:
    def __init__(self):
        ...
        self.access_key_id = 'xxxxxxxxxxxxxxxx'
        self.access_key_secret = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
...
if __name__ == '__main__':
    f = pushAliCdn()
    params = {'Action': 'RefreshObjectCaches', 'ObjectPath': 'http://xxxxxxxxx/Cannon/test.js', 'ObjectType': 'File'}
